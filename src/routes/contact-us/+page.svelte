				...
				<form method="POST">
					...
					<div class="flex flex-row">
						...
						<div class="grid grid-cols-2">
							...
							>
								<option data-countryCode="GB" class="text-sm" value="44"
									>UK (+44)</option
								>
								<option data-countryCode="US" class="text-sm" value="1" selected
									>USA (+1)</option
								>
				...
				<div class="w-[50rem] text-left">
					<div class="section-part h-[21rem] p-10 hover:h-[23rem] hover:p-14">
						...
						<p class="mt-5 text-2xl">
							...
							Our aim good looking website which show our service to customer and
							customer can connect with us
						</p>
					</div>
					<div
