...
export const actions = {
    create: async ({ request }) => {
        ...
        let data = await seq.query(`INSERT INTO customers (name, companyName, email, countryCode, phone, website, service, subservice, createdAt, updatedAt) VALUES ('${formDir.name}', '${formDir.companyName}', '${formDir.email}', '${formDir.countryCode}', '${formDir.phone}', '${formDir.website}', '${formDir.service}', '${formDir.subservice}', '${formDir.createdAt}', '${formDir.updatedAt}');`, {
