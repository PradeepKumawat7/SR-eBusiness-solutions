...
<form action="/database/create?/create" method="post">
	<div class="grid mr-5 form-div bg-blue-950">
		<div>
		...
		<div>
			...
			<input type="email" name="email" id="email" required class="h-10" />
		</div>
		<div>
			<label for="website">website: </label>
			<input type="url" name="website" id="website" required class="h-10" />
		</div>

		<div>
			<label for="country-code">Country Code</label>
			<select name="countryCode" id="country-code" class="h-10" required>
		...
		<div>
			<button type="submit" class="px-4 py-2 font-bold text-white bg-blue-400 rounded ml-[40%]">
				Submit</button
			>
		</div>
</form>
...
<style>
	...
	form > div > div {
		@apply grid place-items-center grid-cols-2 text-white text-center my-5;
	}
</style>
